									...
									<v-form ref="form_paciente" v-model="valid_form">
										<v-row v-if="usuario" align="center">
											...
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" :rules="[v => !!v || 'Campo obligatorio!']" v-model="paciente.nombre" label="Primer Nombre" hide-details outlined required></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off"  v-model="paciente.segundo_nombre" label="Segundo Nombre" hide-details outlined required></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" :rules="[v => !!v || 'Campo obligatorio!']" v-model="paciente.apellido" label="Primer Apellido" hide-details outlined></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.segundo_apellido" label="Segundo Apellido" hide-details outlined></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.dpi" label="DPI" hide-details outlined></v-text-field>
											</v-col>
											...
											<v-col cols="12" sm="6" md="6">
												<v-radio-group class="mt-0" :disabled="!usuario.editar_paciente" :rules="[v => !!v || 'Campo obligatorio!']" v-model="paciente.genero" hide-details row>
											...
											<v-col cols="12" sm="6" md="6">
												...
												>
													<template v-slot:activator="{ on, attrs }">
														<v-text-field
															autocomplete="off"
															:disabled="!usuario.editar_paciente"
											...
											<!-- <v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.calle" label="Calle" hide-details outlined></v-text-field>
											</v-col> -->
											<!-- <v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.avenida" label="Avenida" hide-details outlined></v-text-field>
											</v-col> -->
											<!-- <v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.nomenclatura" label="Nomenclatura" hide-details outlined></v-text-field>
											</v-col> -->
											<v-col cols="12" sm="6" md="6">
												<v-text-field :rules="[v => !!v || 'Campo obligatorio!']" :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.direccion" label="Dirección" hide-details outlined></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-select
													:disabled="!usuario.editar_paciente"
													...
													hide-details
													label="Zona"
													@change="obtener_colonias(paciente.zona)"
												></v-select>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<!-- <v-text-field :disabled="!usuario.editar_paciente || !paciente.zona" autocomplete="off" v-model="paciente.colonia" label="Colonia" hide-details outlined></v-text-field> -->
												<v-select
													:disabled="!usuario.editar_paciente"
													:rules="[v => !!v || 'Campo obligatorio!']"
											...
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente || !paciente.zona" autocomplete="off" v-model="paciente.otra_colonia" label="Otra Colonia" hide-details outlined></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
												<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.barrio" label="Barrio u Otro" hide-details outlined></v-text-field>
											</v-col>
											<v-col cols="12" sm="6" md="6">
											...
											<v-col cols="12" sm="6" md="12">
												<v-checkbox true-value="S" :disabled="!usuario.editar_paciente" v-model="paciente.contacto_paciente_positivo" hide-details class="mx-2 mt-0" label="Tuvo contacto con un paciente COVID positivo"></v-checkbox>
											</v-col>
											...
											<v-col v-if="paciente.contacto_paciente_positivo" cols="12" sm="6" md="12">
												<v-card>
													<v-card-text>
														<v-row>
															<v-col cols="12" sm="6" md="6">
																<v-text-field :disabled="!usuario.editar_paciente" autocomplete="off" v-model="paciente.cuanto_tiempo_contacto" label="Hace cúanto tiempo tuvo el contacto" hide-details outlined></v-text-field>
															</v-col>
															<v-col cols="12" sm="6" md="6">
																<v-text-field :disabled="!usuario.editar_paciente"  autocomplete="off" v-model="paciente.por_cuanto_tiempo_contacto" label="Por cuánto tiempo ha mantenido el contacto" hide-details outlined></v-text-field>
															</v-col>
															<v-col cols="12" sm="6" md="6">
																<v-checkbox true-value="S" :disabled="!usuario.editar_paciente" v-model="paciente.vive_mismo_lugar" hide-details class="mx-2 mt-0" label="Vive en el mismo lugar que el paciente positivo"></v-checkbox>
											...
											<v-col cols="12" sm="6" md="12">
												<v-checkbox true-value="S" :disabled="!usuario.editar_paciente" v-model="paciente.atencion_sin_equipo" hide-details class="mx-2 mt-0" label="Ha brindado atención sin equipo de protección adecuado a un caso confirmado en o fuera de un entorno médico"></v-checkbox>
											</v-col>
											...
											<v-row class="mt-2" v-for="categoria in categorias" :key="categoria.id">
												...
												<v-col v-for="verificacion in categoria.verificaciones" :key="verificacion.id" cols="12" sm="6" md="6">
													<v-row align="center" dense no-gutters>
														<v-col cols="10">
															<v-checkbox :disabled="!usuario.editar_paciente" v-model="verificacion.checked" hide-details class="mx-2 pt-0 mt-0" :label="verificacion.nombre"></v-checkbox>
														</v-col>
														<v-col>
														...
														<v-col v-if="verificacion.mostrar_observacion" class="mt-4" cols="12">
															<v-textarea :disabled="!usuario.editar_paciente" v-model="verificacion.comentario" :label="verificacion.etiqueta_observacion" hide-details outlined rows="3">
