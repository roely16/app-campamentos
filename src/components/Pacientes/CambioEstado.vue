<template>
    <div>
        ...
        >
            <v-card>
                <v-card-title class="headline mb-4">Cambio de Estado</v-card-title>
                ...
                <v-card-text>
                    <v-form ref="form_cambio_estado" v-model="valid_form">
                        <v-row>
                            ...
                            <v-col>
                                <v-combobox :rules="[v => !!v || 'Campo obligatorio!']" v-model="estado" outlined label="Estado" :items="estados" item-text="nombre" item-value="id"></v-combobox>
                            </v-col>
                        </v-row>
        ...
        methods: {
            ...
            cambiar_estado(){
                ...
                if (this.valid_form) {
                    ...
                    this.axios.post(process.env.VUE_APP_API_URL + 'cambiar_estado.php', data)
                    .then((response) => {
        ...
        watch: {
            ...
            show_dialog(val){
                ...
                if (val) {
                    ...
                    this.axios.post(process.env.VUE_APP_API_URL + 'obtener_estados_rol.php', data)
                    .then((response) => {
