            ...
            <v-row>
                <v-col>
                    <v-tabs v-model="tab" background-color="primary" show-arrows dark>
                        <v-tab>Asignados</v-tab>
                        <v-tab>Atendidos</v-tab>
                    </v-tabs>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            obtener_pacientes_medico_p(val){
                ...
                this.axios.post(process.env.VUE_APP_API_URL + 'obtener_pacientes_medico_p.php', data)
                .then((response) => {
                    console.log(response.data)
                    // this.paciente_asignado = response.data
                    this.items = response.data.items
        ...
        watch: {
            ...
            tab: function(val){
                ...
                this.obtener_pacientes_medico_p(val)
        ...
        mounted(){
            ...
            this.detalle_usuario()
            this.obtener_pacientes_medico_p(this.tab)
            // this.obtener_pacientes()
