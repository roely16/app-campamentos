        ...
        <v-container fluid style="background-image: url('./img/fondoLogin.png'); height: 100vh; background-size:cover">
            ...
            <v-row justify="center" align="center" style="height: 25vh">
                <v-col v-if="activando" xs="12" lg="6" sm="6">
                    <h3 class="white--text">La cuenta esta siendo aprobada...</h3>
                    <v-progress-linear
                        indeterminate
                ...
                <v-col xs="12" lg="4" sm="6" v-if="!activando">
                    <v-alert border="left" colored-border class="mt-4" dense type="success">
                        <h3 class="text-center">La cuenta a sido aprobada exitosamente.</h3>
                    </v-alert>
                </v-col>
    ...
    export default {
        ...
        methods: {
            activar_cuenta(){
                ...
                this.axios.post(process.env.VUE_APP_API_URL + 'aceptar_cuenta.php', data)
                .then((response) => {
